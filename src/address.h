...
public:
    ...
    static bool Lookup(std::vector<Ref<Address>>& result, const std::string& host, int family = AF_UNSPEC, int type = 0, int protocol = 0);
    static Ref<Address> LookupAny(std::string& host, int family = AF_UNSPEC, int type = 0, int protocol = 0);
    static Ref<IPAddress> LookupIPAddress(std::string& host, int family = AF_UNSPEC, int type = 0, int protocol = 0);

    static bool GetInterfaceAddress(std::multimap<std::string, std::pair<Ref<Address>, uint32_t>>& result,
        int family = AF_UNSPEC);
    
    static bool GetInterfaceAddress(std::vector<std::pair<Ref<Address>, uint32_t>>& result, const std::string& ifcae, int family = AF_UNSPEC);
...
{
public:
    static Ref<IPAddress> Create(const char* address, uint32_t port = 0); 
    ...
    virtual void setPort(uint32_t prot) = 0;
};
...
public:
    ...
    static Ref<IPv4Address> Create(const char* address, uint32_t port = 0);
...
public:
    ...
    static Ref<IPv6Address> Create(const char* address, uint32_t port = 0);
