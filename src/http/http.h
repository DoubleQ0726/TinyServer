...
//http==协议 www.baidu.com==host 80==端口 /page/xxx==path id=10&v=20==param fr==fragment
class HttpRequest
{
public:
    ...
    std::string getParma(const std::string& key, const std::string& def = "") const;
